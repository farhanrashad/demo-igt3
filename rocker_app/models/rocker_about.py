...
class rocker_about(models.TransientModel):
    ...
    paypal = fields.Html(string="PayPal", readonly=True, default='''<p><p>If you like these reports, please click:<p>  <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
