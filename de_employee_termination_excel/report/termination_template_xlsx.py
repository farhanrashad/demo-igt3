...
class TerminationXLSXReport(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet.write(5, 2, 'Departure Date', format1)
        sheet.write(5, 3, 'Departure Reason', format1)
        sheet.write(5, 4, 'Additional Information', format1)
        ...
        for emp in all_emp:
            ...
            sheet.write(row, 2, str(emp.departure_date), format2)
            sheet.write(row, 3, emp.departure_reason, format2)
            sheet.write(row, 4, emp.departure_description, format2)
