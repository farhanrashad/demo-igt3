...
class AccountMove(models.Model):
    ...
    #payment_ids = fields.Many2one('account.payment', string='Payments', compute='_compute_payments')
    payment_ids = fields.Char(string='Payments', compute='_compute_payments')
