...
class ReportTrialBalance(models.AbstractModel):
    ...
    def _get_accounts(self, accounts, display_account, currency_id):
            ...
            if account.id in account_result:
                ...
                if currency.id != currency_id:
                    currency_obj = self.env['res.currency'].search(
                        [('active', '=', True), ('id', '=', currency_id)])
                    res['debit'] =round(res['debit'] * currency_obj.rate,2)
                    res['credit'] = round(res['credit'] * currency_obj.rate,2)
                    res['balance'] = round(res['balance'] * currency_obj.rate,2)
