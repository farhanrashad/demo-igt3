...
class AccountMove(models.Model):
    ...
    penalty_entry_id = fields.Many2one('op.penalty.type', 'Penalty Type', ondelete='set null', index=True)
...
class AccountMoveLine(models.Model):
    ...
    penalty_entry_line_id = fields.Many2one('op.penalty.entry.line', 'Penalty Entry Line', ondelete='set null', index=True)
    penalty_entry_id = fields.Many2one('op.penalty.entry', 'Penalty Entry', related='penalty_entry_line_id.penalty_entry_id', readonly=True)